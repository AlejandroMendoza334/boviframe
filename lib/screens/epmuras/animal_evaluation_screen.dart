        ...
        await showDialog(
          ...
          builder:
              (_) => AlertDialog(
                ...
                content: const Text(
                  'La imagen comprimida sigue ocupando más de 1 MB.\n\n'
                  'Recomendaciones:\n'
                  '• Recórtala antes de subirla para centrar solo el animal.\n'
                  '• Reduce su resolución o calidad.\n'
                  '• Utiliza una herramienta de edición o app móvil para ajustar el tamaño.',
                ),
                actions: [
                  TextButton(
        ...
        builder:
            (_) => AlertDialog(
              ...
              content: const Text(
                ...
                'Intenta recortar la foto o usar otra imagen más pequeña.',
              ),
              actions: [
                TextButton(
                  onPressed: () => Navigator.pop(context),
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            ...
            final datosUsuario = <pw.Widget>[
              ...
              pw.Text('Ubicación: $userLoc', style: pw.TextStyle(fontSize: 12)),
